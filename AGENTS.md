...
- **Before creating, moving, renaming, or archiving any document**, read `dist/skills/doc-placement/SKILL.md` (the source copy in this repository)
- **Before running any `gh pr merge`**, read `dist/skills/merge-pr/SKILL.md`
